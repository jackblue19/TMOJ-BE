namespace WebAPI.Models.Common
{
    public class Class
    {
        //  có thể là sẽ chuyển đối xí là ném mấy cái như apiresonse.request <T> vô folder này
        //  vì có thể bổ sung thêm 1 số cái như pagedresponses<T> nữa chẳng hạn
        //  sp search đồ, bla bla, ...
